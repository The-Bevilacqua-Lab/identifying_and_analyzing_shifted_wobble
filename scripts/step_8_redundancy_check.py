...
#for standard wobble
#D1= pd.read_csv('all_standard_wobble_residue_index_adjusted.csv')
#for shifted wobble
D1= pd.read_csv('all_shifted_wobble_residue_index_adjusted.csv')
...
#for standard wobble
D3.to_csv('all_standard_wobble_redundancy_checked.csv', index= False)

#for shifted wobble
D3.to_csv('all_shifted_wobble_redundancy_checked.csv', index= False)